...
import { Box, Typography, Card, CardContent, List, ListItem, TextField, IconButton, Link } from '@mui/material';
            ...
            <ListItem key={record.id}>
              <Card sx={{ width: '100%' }}>
                <CardContent>
                  ...
                  {record.pdfUrl && (
                    <Link href={record.pdfUrl} target="_blank" rel="noopener" sx={{ display: 'flex', alignItems: 'center', mt: 2 }}>
                      <PictureAsPdfIcon sx={{ fontSize: 40, color: 'primary.main', mr: 1 }} />
